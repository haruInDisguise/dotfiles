...
typeset -a paths=(
    ...
    "$DOTFILES_CONFIG/fuzzel"       "$TARGET_CONFIG/fuzzel"
    "$DOTFILES_CONFIG/gdb"          "$TARGET_CONFIG/gdb"
    "$DOTFILES_CONFIG/ghostty"      "$TARGET_CONFIG/ghostty"
    "$DOTFILES_CONFIG/lesskey"      "$TARGET_CONFIG/lesskey"
    ...
    "$DOTFILES_CONFIG/spotifyd"     "$TARGET_CONFIG/spotifyd"
